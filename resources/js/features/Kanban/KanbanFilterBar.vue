...
const CHIP_KEYS = ['search', 'priority_id', 'project_id', 'category_id', 'type_id', 'assigned_to', 'company_id'];
...
const resolveLabel = (key, value) => {
    ...
    if (key === 'company_id')  return props.companies.find(c  => c.id == value)?.name ?? value;
