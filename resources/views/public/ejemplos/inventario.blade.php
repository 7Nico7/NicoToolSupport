...
@section('title', 'Demo — Sistema de Inventario ERP')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-3xl" data-aos="fade-up">
            ...
            <h1 class="text-4xl md:text-5xl font-black leading-tight mb-5">
                Demo: Sistema de<br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-teal-300">Inventario</span>
            </h1>
            <p class="text-lg text-primary-200/80 leading-relaxed max-w-2xl">Control total de existencias, movimientos y alertas de stock mínimo. Todo en tiempo real.</p>
        </div>
    </div>
</section>
...
<section class="py-8 bg-background-light dark:bg-background-dark">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="rounded-b-2xl overflow-hidden border-x border-b
             ...
             style="height: 720px;">
            <iframe
                src="{{ route('demo.inventario') }}"
                frameborder="0"
                style="width:100%;height:100%;border:none;"
                title="Demo de Inventario"
                allow="fullscreen"
                id="demoIframe">
            </iframe>
        </div>
            ...
            <ul class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    <li class="flex items-start gap-2.5">
                        ...
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Existencias en tiempo real:</strong> Niveles de stock actualizados al instante
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Movimientos:</strong> Entradas, salidas y ajustes registrados
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Alertas de stock mínimo:</strong> Avisos automáticos cuando el inventario es bajo
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Escaneo de códigos:</strong> Búsqueda por código de barras o QR
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Categorías:</strong> Organización por familias y subfamilias
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Exportar:</strong> Reportes de existencia en Excel o PDF
                        </span>
                    </li>
            </ul>
        </div>
...
<script>
    function openDemo() {
        window.open('{{ route('demo.inventario') }}', '_blank', 'width=1280,height=820');
    }
</script>
@endpush
