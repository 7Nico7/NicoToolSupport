...
@section('title', 'Demo — Sistema de Facturación ERP')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-3xl" data-aos="fade-up">
            ...
            <h1 class="text-4xl md:text-5xl font-black leading-tight mb-5">
                Demo: Sistema de<br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-300 to-primary-400">Facturación</span>
            </h1>
            <p class="text-lg text-primary-200/80 leading-relaxed max-w-2xl">Facturas electrónicas, seguimiento de pagos y gestión completa de CFDI en un solo módulo.</p>
        </div>
    </div>
</section>
...
<section class="py-8 bg-background-light dark:bg-background-dark">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="rounded-b-2xl overflow-hidden border-x border-b
             ...
             style="height: 720px;">
            <iframe
                src="{{ route('demo.facturacion') }}"
                frameborder="0"
                style="width:100%;height:100%;border:none;"
                title="Demo de Facturación"
                allow="fullscreen"
                id="demoIframe">
            </iframe>
        </div>
            ...
            <ul class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    <li class="flex items-start gap-2.5">
                        ...
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Tabla interactiva:</strong> Ordena, filtra y busca facturas fácilmente
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Facturación electrónica:</strong> CFDI, complementos de pago y cancelación
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Múltiples estados:</strong> Pagadas, pendientes y canceladas con colores
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Exportar:</strong> PDF, XML y Excel desde la misma vista
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Dashboard:</strong> Resumen de ventas e indicadores clave
                        </span>
                    </li>
                    <li class="flex items-start gap-2.5">
                        <span class="material-symbols-outlined text-success text-[15px] ms-filled shrink-0 mt-0.5">check_circle</span>
                        <span class="text-sm text-gray-700 dark:text-gray-300">
                            <strong class="font-semibold text-gray-900 dark:text-white">Notificaciones:</strong> Alertas de facturas próximas a vencer
                        </span>
                    </li>
            </ul>
        </div>
...
<script>
    function openDemo() {
        window.open('{{ route('demo.facturacion') }}', '_blank', 'width=1280,height=820');
    }
</script>
@endpush
